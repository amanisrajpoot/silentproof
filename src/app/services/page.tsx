...
import { Shield, Lock, Search, UserCheck, EyeOff, Building2, UserPlus, ArrowRight } from "lucide-react";
    ...
    const services = [
        {
            ...
            icon: UserCheck,
            description: "Pre-wedding and post-wedding background verification to ensure clarity in personal commitments.",
        },
        {
            slug: "corporate",
            title: "Corporate Fraud",
            icon: Building2,
            description: "Protecting business interests through due diligence, asset tracing, and fraud investigations.",
        },
        {
            slug: "background",
            title: "Person Search",
            icon: Search,
            description: "Comprehensive background checks and skips tracing to locate or verify individuals.",
        },
        {
            slug: "surveillance",
            title: "Surveillance",
            icon: EyeOff,
            description: "High-discretion physical and digital monitoring with encrypted evidence logs.",
        }
    ];
